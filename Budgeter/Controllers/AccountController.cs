        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    if (UserManager.FindByEmail(model.Email).HouseHoldId != null)
                    {
                        return RedirectToAction("details", "households", new { id = UserManager.FindByEmail(model.Email).HouseHoldId });
                    }
